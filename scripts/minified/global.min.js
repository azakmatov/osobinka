var Swiper = function () {
  ...
  function f(e) {
    ...
    for (let e = 1; e < arguments.length; e += 1) {
      ...
      if (null != a && (l = a, !("undefined" != typeof window && void 0 !== window.HTMLElement ? l instanceof HTMLElement : l && (1 === l.nodeType || 11 === l.nodeType)))) {
        ...
        for (let e = 0, t = l.length; e < t; e += 1) {
          ...
          void 0 !== r && r.enumerable && (d(s[i]) && d(a[i]) ? a[i].__swiper__ ? s[i] = a[i] : f(s[i], a[i]) : d(s[i]) || !d(a[i]) || (s[i] = {}, a[i].__swiper__) ? s[i] = a[i] : f(s[i], a[i]))
        }
      }
    }
    var l;
  ...
  function w(e) {
    ...
    const r = P(), l = -s.translate;
    let n, o = null;
    const d = s.params.speed,
      c = (s.wrapperEl.style.scrollSnapType = "none", r.cancelAnimationFrame(s.cssModeFrameID), a > l ? "next" : "prev"),
      p = (e, t) => "next" === c && t <= e || "prev" === c && e <= t, u = () => {
        n = (new Date).getTime(), null === o && (o = n);
        var e = Math.max(Math.min((n - o) / d, 1), 0), e = .5 - Math.cos(e * Math.PI) / 2;
        let t = l + e * (a - l);
        p(t, a) && (t = a), s.wrapperEl.scrollTo({[i]: t}), p(t, a) ? (s.wrapperEl.style.overflow = "hidden", s.wrapperEl.style.scrollSnapType = "", setTimeout(() => {
  ...
  function D(e) {
    var t = P(), s = A(), a = e.getBoundingClientRect(), s = s.body, i = e.clientTop || s.clientTop || 0,
      s = e.clientLeft || s.clientLeft || 0, r = e === t ? t.scrollY : e.scrollTop,
      t = e === t ? t.scrollX : e.scrollLeft;
    return {top: a.top + r - i, left: a.left + t - s}
  }
    ...
    if (a && !a.destroyed && a.params) {
      ...
      if (i && s && !(s < 0)) {
        ...
        if (a.params.grid && 1 < a.params.grid.rows) {
          const i = l, n = [i - s];
          n.push(...Array.from({length: s}).map((e, t) => i + r + t)), void a.slides.forEach((e, t) => {
            n.includes(e.column) && o(a, t)
          })
        } else {
          const n = l + r - 1;
          if (a.params.rewind || a.params.loop) for (let t = l - s; t <= n + s; t += 1) {
            const e = (t % i + i) % i;
            (e < l || e > n) && o(a, e)
          } else for (let e = Math.max(l - s, 0); e <= Math.min(n + s, i - 1); e += 1) e !== l && (e > n || e < l) && o(a, e)
        }
      }
    }
  };
  ...
  function B(e) {
    var {swiper: e, runCallbacks: t, direction: s, step: a} = e, {activeIndex: i, previousIndex: r} = e;
    let l = s;
    if (l = l || (r < i ? "next" : i < r ? "prev" : "reset"), e.emit("transition" + a), t && i !== r) {
      if ("reset" === l) return e.emit("slideResetTransition" + a);
      e.emit("slideChangeTransition" + a), "next" === l ? e.emit("slideNextTransition" + a) : e.emit("slidePrevTransition" + a)
    }
  }

  function $(e, t, s) {
    var a = P(), e = e["params"], i = e.edgeSwipeDetection, e = e.edgeSwipeThreshold;
  ...
  const V = (e, t) => {
    var s = A(), {params: a, el: i, wrapperEl: r, device: l} = e, n = !!a.nested,
    ...
    s[o]("touchstart", e.onDocumentTouchStart, {
      ...
      passive: !1,
      capture: n
    }), s[o]("touchend", e.onTouchEnd, {passive: !0}), s[o]("pointerup", e.onTouchEnd, {passive: !0}), s[o]("pointercancel", e.onTouchEnd, {passive: !0}), s[o]("touchcancel", e.onTouchEnd, {passive: !0}), s[o]("pointerout", e.onTouchEnd, {passive: !0}), s[o]("pointerleave", e.onTouchEnd, {passive: !0}), s[o]("contextmenu", e.onTouchEnd, {passive: !0}), (a.preventClicks || a.preventClicksPropagation) && i[o]("click", e.onClick, !0), a.cssMode && r[o]("scroll", e.onScroll), a.updateOnWindowResize ? e[t](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", R, !0) : e[t]("observerUpdate", R, !0), i[o]("load", e.onLoad, {capture: !0})
  }, _ = (e, t) => e.grid && t.grid && 1 < t.grid.rows;
  var F = {
    init: !0,
    ...
    eventsEmitter: {
      ...
      updateSize: function () {
        ...
        const r = a.params, {wrapperEl: l, slidesEl: t, size: n, rtlTranslate: o, wrongRTL: d} = a,
          ...
          p = k(t, `.${a.params.slideClass}, swiper-slide`), u = (c ? a.virtual.slides : p).length;
        let m = [];
        const h = [], f = [];
        ...
        if (void 0 !== n) {
          ...
          }), r.centeredSlides && r.cssMode && (L(l, "--swiper-centered-offset-before", ""), L(l, "--swiper-centered-offset-after", ""));
          ...
          for (let t = 0; t < u; t += 1) {
            ...
            if (s = 0, p[t] && (e = p[t]), T && a.grid.updateSlide(t, e, p), !p[t] || "none" !== C(e, "display")) {
              if ("auto" === r.slidesPerView) {
                ...
                if (o && (e.style.transform = "none"), d && (e.style.webkitTransform = "none"), r.roundLengths) s = a.isHorizontal() ? H(e, "width", !0) : H(e, "height", !0); else {
                  const a = i(n, "width"), r = i(n, "padding-left"), l = i(n, "padding-right"), o = i(n, "margin-left"),
                    d = i(n, "margin-right"), c = n.getPropertyValue("box-sizing");
          ...
          if (Object.assign(a, {
            ...
            L(l, "--swiper-centered-offset-before", -m[0] + "px"), L(l, "--swiper-centered-offset-after", a.size / 2 - f[f.length - 1] / 2 + "px");
        ...
        if (0 !== l.length) {
          ...
          for (let t = 0; t < l.length; t += 1) {
            ...
            var c = (s + (r.centeredSlides ? i.minTranslate() : 0) - e) / (d.swiperSlideSize + a),
              p = (s - o[0] + (r.centeredSlides ? i.minTranslate() : 0) - e) / (d.swiperSlideSize + a), u = -(s - e),
              m = u + i.slidesSizesGrid[t], h = 0 <= u && u <= i.size - i.slidesSizesGrid[t];
            (0 <= u && u < i.size - 1 || 1 < m && m <= i.size || u <= 0 && m >= i.size) && (i.visibleSlides.push(d), i.visibleSlidesIndexes.push(t), l[t].classList.add(r.slideVisibleClass)), h && l[t].classList.add(r.slideFullyVisibleClass), d.progress = n ? -c : c, d.originalProgress = n ? -p : p
          }
        }
        ...
        if (s.loop) {
          const s = t.getSlideIndexByData(0), a = t.getSlideIndexByData(t.slides.length - 1), i = t.slidesGrid[s],
            r = t.slidesGrid[a], l = t.slidesGrid[t.slidesGrid.length - 1], o = Math.abs(e);
          1 < (n = o >= i ? (o - i) / l : (o + l - r) / l) && --n
        }
        Object.assign(t, {
          progress: i,
          progressLoop: n,
        ...
        const t = this, {slides: e, params: s, slidesEl: a, activeIndex: i} = t, r = t.virtual && s.virtual.enabled,
          l = t.grid && s.grid && 1 < s.grid.rows, n = e => k(a, `.${s.slideClass}${e}, swiper-slide` + e)[0];
        let o, d, c;
        if (e.forEach(e => {
        ...
        o && (o.classList.add(s.slideActiveClass), l ? c && c.classList.add(s.slideNextClass) : (c = function (e, t) {
          ...
          return s
        }(o, `.${s.slideClass}, swiper-slide`)[0], (c = s.loop && !c ? e[0] : c) && c.classList.add(s.slideNextClass), d = function (e, t) {
      ...
      }, updateActiveIndex: function (s) {
        const a = this, e = a.rtlTranslate ? a.translate : -a.translate, {
          snapGrid: t,
          params: i,
          activeIndex: r,
          realIndex: l,
        ...
        }(a)), 0 <= t.indexOf(e)) o = t.indexOf(e); else {
          const s = Math.min(i.slidesPerGroupSkip, d);
          o = s + Math.floor((d - s) / i.slidesPerGroup)
        }
        if (o >= t.length && (o = t.length - 1), d !== r || a.params.loop) if (d === r && a.params.loop && a.virtual && a.params.virtual.enabled) a.realIndex = s(d); else {
          var c = a.grid && i.grid && 1 < i.grid.rows;
          let t;
          if (a.virtual && i.virtual.enabled && i.loop) t = s(d); else if (c) {
            const s = a.slides.filter(e => e.column === d)[0];
            let e = parseInt(s.getAttribute("data-swiper-slide-index"), 10);
            Number.isNaN(e) && (e = Math.max(a.slides.indexOf(s), 0)), t = Math.floor(e / i.grid.rows)
          } else if (a.slides[d]) {
            const s = a.slides[d].getAttribute("data-swiper-slide-index");
            t = s ? parseInt(s, 10) : d
          } else t = d;
          Object.assign(a, {
            previousSnapIndex: n,
            ...
            previousIndex: r,
            activeIndex: d
          }), a.initialized && p(a), a.emit("activeIndexChange"), a.emit("snapIndexChange"), (a.initialized || a.params.runCallbacksOnInit) && (l !== t && a.emit("realIndexChange"), a.emit("slideChange"))
        } else o !== n && (a.snapIndex = o, a.emit("snapIndexChange"))
        ...
        i && l ? (s.clickedSlide = i, s.virtual && s.params.virtual.enabled ? s.clickedIndex = parseInt(i.getAttribute("data-swiper-slide-index"), 10) : s.clickedIndex = r, a.slideToClickedSlide && void 0 !== s.clickedIndex && s.clickedIndex !== s.activeIndex && s.slideToClickedSlide()) : (s.clickedSlide = void 0, s.clickedIndex = void 0)
      }
    }, translate: {
      getTranslate: function (e) {
        ...
        var s = this, {rtlTranslate: a, params: i, wrapperEl: r, progress: l} = s;
        let n = 0, o = 0;
        ...
        (0 == a ? 0 : (e - s.minTranslate()) / a) !== l && s.updateProgress(e), s.emit("setTranslate", s.translate, t)
        ...
        var o = r.minTranslate(), d = r.maxTranslate(), o = a && o < e ? o : a && e < d ? d : e;
        if (r.updateProgress(o), l.cssMode) {
          const e = r.isHorizontal();
          if (0 === t) n[e ? "scrollLeft" : "scrollTop"] = -o; else {
            if (!r.support.smoothScroll) return w({swiper: r, targetPosition: -o, side: e ? "left" : "top"}), !0;
            n.scrollTo({[e ? "left" : "top"]: -o, behavior: "smooth"})
          }
        } else 0 === t ? (r.setTransition(0), r.setTranslate(o), s && (r.emit("beforeTransitionStart", t, i), r.emit("transitionEnd"))) : (r.setTransition(t), r.setTranslate(o), s && (r.emit("beforeTransitionStart", t, i), r.emit("transitionStart")), r.animating || (r.animating = !0, r.onTranslateToWrapperTransitionEnd || (r.onTranslateToWrapperTransitionEnd = function (e) {
      ...
      setTransition: function (e, t) {
        ...
        void 0 === e && (e = !0);
        var s = this["params"];
        s.cssMode || (s.autoHeight && this.updateAutoHeight(), B({
          swiper: this,
          runCallbacks: e,
          direction: t,
          step: "Start"
        ...
        void 0 === e && (e = !0);
        var s = this["params"];
        this.animating = !1, s.cssMode || (this.setTransition(0), B({
          swiper: this,
          runCallbacks: e,
          direction: t,
          step: "End"
      ...
      slideTo: function (e, t, s, a, i) {
        ...
        } else r.setTransition(t), r.setTranslate(v), r.updateActiveIndex(l), r.updateSlidesClasses(), r.emit("beforeTransitionStart", t, a), r.transitionStart(s, g), 0 === t ? r.transitionEnd(s, g) : r.animating || (r.animating = !0, r.onSlideToWrapperTransitionEnd || (r.onSlideToWrapperTransitionEnd = function (e) {
        ...
        if (n.params.loop) if (n.virtual && n.params.virtual.enabled) d += n.virtual.slidesBefore; else {
          ...
          const i = o ? Math.ceil(n.slides.length / n.params.grid.rows) : n.slides.length,
            r = n.params["centeredSlides"];
          let t = n.params.slidesPerView,
            s = ("auto" === t ? t = n.slidesPerViewDynamic() : (t = Math.ceil(parseFloat(n.params.slidesPerView, 10)), r && t % 2 == 0 && (t += 1)), i - e < t);
          if (s = r ? s || e < Math.ceil(t / 2) : s) {
        ...
        let f = 0;
        if (void 0 !== h && ((f = l.indexOf(h)) < 0 && (f = a.activeIndex - 1), "auto" === i.slidesPerView) && 1 === i.slidesPerGroup && i.slidesPerGroupAuto && (f = f - a.slidesPerViewDynamic("previous", !0) + 1, f = Math.max(f, 0)), i.rewind && a.isBeginning) {
        ...
        var i = this;
        let r = i.activeIndex;
        var l = Math.min(i.params.slidesPerGroupSkip, r), l = l + Math.floor((r - l) / i.params.slidesPerGroup),
          n = i.rtlTranslate ? i.translate : -i.translate;
        if (n >= i.snapGrid[l]) {
          const e = i.snapGrid[l];
          n - e > (i.snapGrid[l + 1] - e) * a && (r += i.params.slidesPerGroup)
        } else {
          const e = i.snapGrid[l - 1];
          n - e <= (i.snapGrid[l] - e) * a && (r -= i.params.slidesPerGroup)
        }
        ...
        t.loop ? e.animating || (i = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - a / 2 || r > e.slides.length - e.loopedSlides + a / 2 ? (e.loopFix(), r = e.getSlideIndex(k(s, l + `[data-swiper-slide-index="${i}"]`)[0]), M(() => {
          e.slideTo(r)
        })) : e.slideTo(r) : r > e.slides.length - a ? (e.loopFix(), r = e.getSlideIndex(k(s, l + `[data-swiper-slide-index="${i}"]`)[0]), M(() => {
          e.slideTo(r)
      ...
      loopCreate: function (e) {
        ...
        if (m.params.loop) {
          ...
          if (m.allowSlidePrev = !0, m.allowSlideNext = !0, m.virtual && S.virtual.enabled) n && (S.centeredSlides || 0 !== m.snapIndex ? S.centeredSlides && m.snapIndex < S.slidesPerView ? m.slideTo(m.virtual.slides.length + m.snapIndex, 0, !1, !0) : m.snapIndex === m.snapGrid.length - 1 && m.slideTo(m.virtual.slidesBefore, 0, !1, !0) : m.slideTo(m.virtual.slides.length, 0, !1, !0)), m.allowSlidePrev = y, m.allowSlideNext = E; else {
            ...
            b.length < e + t ? z("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : h && "row" === S.grid.fill && z("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
            const M = [], C = [];
            let s = m.activeIndex;
            void 0 === c ? c = m.getSlideIndex(b.filter(e => e.classList.contains(S.slideActiveClass))[0]) : s = c;
            var f = "next" === o || !o, v = "prev" === o || !o;
            let a = 0, i = 0;
            var g = h ? Math.ceil(b.length / S.grid.rows) : b.length,
              w = (h ? b[c].column : c) + (T && void 0 === d ? -e / 2 + .5 : 0);
            if (w < t) {
              a = Math.max(t - w, r);
              for (let e = 0; e < t - w; e += 1) {
                ...
                if (h) {
                  const r = g - l - 1;
                  for (let e = b.length - 1; 0 <= e; --e) b[e].column === r && M.push(e)
                } else M.push(g - l - 1)
              }
            } else if (w + e > g - t) {
              i = Math.max(w - (g - 2 * t), r);
              for (let e = 0; e < i; e += 1) {
                const l = e - Math.floor(e / g) * g;
                h ? b.forEach((e, t) => {
                  e.column === l && C.push(t)
            ...
            if (m.__preventObserver__ = !0, requestAnimationFrame(() => {
            ...
            }), m.recalcSlides(), "auto" === S.slidesPerView ? m.updateSlides() : h && (0 < M.length && v || 0 < C.length && f) && m.slides.forEach((e, t) => {
              m.grid.updateSlide(t, e, m.slides)
            }), S.watchSlidesProgress && m.updateSlidesOffset(), n) if (0 < M.length && v) {
              if (void 0 === l) {
                const r = m.slidesGrid[s], l = m.slidesGrid[s + a] - r;
                ...
                const r = h ? M.length / S.grid.rows : M.length;
                m.slideTo(m.activeIndex + r, 0, !1, !0), m.touchEventsData.currentTranslate = m.translate
              }
            } else if (0 < C.length && f) if (void 0 === l) {
              const r = m.slidesGrid[s], l = m.slidesGrid[s - i] - r;
              ...
              const r = h ? C.length / S.grid.rows : C.length;
              m.slideTo(m.activeIndex - r, 0, !1, !0)
            }
            if (m.allowSlidePrev = y, m.allowSlideNext = E, m.controller && m.controller.control && !p) {
              const r = {slideRealIndex: l, direction: o, setTranslate: d, activeSlideIndex: c, byController: !0};
      ...
      attachEvents: function () {
        ...
        e.onTouchStart = function (s) {
          ...
          if ("touchstart" === r.type) $(a, r, r.targetTouches[0].pageX); else {
            ...
            if (o && (l.simulateTouch || "mouse" !== r.pointerType) && (!a.animating || !l.preventInteractionOnTransition)) {
              ...
              if (("wrapper" !== l.touchEventsTarget || a.wrapperEl.contains(t)) && !("which" in r && 3 === r.which || "button" in r && 0 < r.button || s.isTouched && s.isMoved)) {
                var o = !!l.noSwipingClass && "" !== l.noSwipingClass, d = r.composedPath ? r.composedPath() : r.path,
                ...
                if (l.noSwiping && (d ? function (a, e) {
                  return function e(t) {
                    var s;
                    return t && t !== A() && t !== P() && ((s = (t = t.assignedSlot ? t.assignedSlot : t).closest(a)) || t.getRootNode) ? s || e(t.getRootNode().host) : null
                  }(e = void 0 === t ? this : e)
                }(o, t) : t.closest(o))) a.allowClick = !0; else if (!l.swipeHandler || t.closest(l.swipeHandler)) {
                  ...
                  if ($(a, r, d)) {
                    Object.assign(s, {
                      ...
                      isScrolling: void 0,
                      startMoving: void 0
                    }), n.startX = d, n.startY = o, s.touchStartTime = g(), a.allowClick = !0, a.updateSize(), a.swipeDirection = void 0, 0 < l.threshold && (s.allowThresholdMove = !1);
                    let e = !0;
          ...
          const s = A(), i = this, r = i.touchEventsData, {params: l, touches: n, rtlTranslate: o, enabled: e} = i;
          if (e && (l.simulateTouch || "mouse" !== t.pointerType)) {
            ...
            if ("touchmove" === a.type) {
              if (!(e = [...a.changedTouches].filter(e => e.identifier === r.touchId)[0]) || e.identifier !== r.touchId) return
            } else e = a;
            if (r.isTouched) {
              var t = e.pageX, d = e.pageY;
              if (a.preventedByNestedSwiper) n.startX = t, n.startY = d; else if (i.allowTouchMove) {
                if (l.touchReleaseOnEdges && !l.loop) if (i.isVertical()) {
                  if (d < n.startY && i.translate <= i.maxTranslate() || d > n.startY && i.translate >= i.minTranslate()) return r.isTouched = !1, void (r.isMoved = !1)
                } else if (t < n.startX && i.translate <= i.maxTranslate() || t > n.startX && i.translate >= i.minTranslate()) return;
                if (s.activeElement && a.target === s.activeElement && a.target.matches(r.focusableElements)) r.isMoved = !0, i.allowClick = !1; else {
                  r.allowTouchCallbacks && i.emit("touchMove", a), n.previousX = n.currentX, n.previousY = n.currentY, n.currentX = t, n.currentY = d;
                  var c = n.currentX - n.startX, p = n.currentY - n.startY;
                  if (!(i.params.threshold && Math.sqrt(c ** 2 + p ** 2) < i.params.threshold)) if (void 0 === r.isScrolling && (i.isHorizontal() && n.currentY === n.startY || i.isVertical() && n.currentX === n.startX ? r.isScrolling = !1 : 25 <= c * c + p * p && (u = 180 * Math.atan2(Math.abs(p), Math.abs(c)) / Math.PI, r.isScrolling = i.isHorizontal() ? u > l.touchAngle : 90 - u > l.touchAngle)), r.isScrolling && i.emit("touchMoveOpposite", a), void 0 !== r.startMoving || n.currentX === n.startX && n.currentY === n.startY || (r.startMoving = !0), r.isScrolling) r.isTouched = !1; else if (r.startMoving) {
                    ...
                    l.oneWayMovement && (s = Math.abs(s) * (o ? 1 : -1), e = Math.abs(e) * (o ? 1 : -1)), n.diff = s, s *= l.touchRatio, o && (s = -s, e = -e);
                    var u = i.touchesDirection,
                      c = (i.swipeDirection = 0 < s ? "prev" : "next", i.touchesDirection = 0 < e ? "prev" : "next", i.params.loop && !l.cssMode),
                      p = "next" === i.touchesDirection && i.allowSlideNext || "prev" === i.touchesDirection && i.allowSlidePrev;
                    if (!r.isMoved) {
                      if (c && p && i.loopFix({direction: i.swipeDirection}), r.startTranslate = i.getTranslate(), i.setTransition(0), i.animating) {
                        const t = new window.CustomEvent("transitionend", {bubbles: !0, cancelable: !0});
                        i.wrapperEl.dispatchEvent(t)
                      }
                      r.allowMomentumBounce = !1, !l.grabCursor || !0 !== i.allowSlideNext && !0 !== i.allowSlidePrev || i.setGrabCursor(!0), i.emit("sliderFirstMove", a)
                    }
                    if ((new Date).getTime(), r.isMoved && r.allowThresholdMove && u !== i.touchesDirection && c && p && 1 <= Math.abs(s)) Object.assign(n, {
                      startX: t,
                      startY: d,
                      currentX: t,
                      currentY: d,
                      ...
                      i.emit("sliderMove", a), r.isMoved = !0, r.currentTranslate = s + r.startTranslate;
                      let e = !0, t = l.resistanceRatio;
                      if (l.touchReleaseOnEdges && (t = 0), 0 < s ? (c && p && r.allowThresholdMove && r.currentTranslate > (l.centeredSlides ? i.minTranslate() - i.slidesSizesGrid[i.activeIndex + 1] : i.minTranslate()) && i.loopFix({
                        direction: "prev",
                        setTranslate: !0,
                        activeSlideIndex: 0
                      }), r.currentTranslate > i.minTranslate() && (e = !1, l.resistance) && (r.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + r.startTranslate + s) ** t)) : s < 0 && (c && p && r.allowThresholdMove && r.currentTranslate < (l.centeredSlides ? i.maxTranslate() + i.slidesSizesGrid[i.slidesSizesGrid.length - 1] : i.maxTranslate()) && i.loopFix({
                        direction: "next",
                        setTranslate: !0,
                        activeSlideIndex: i.slides.length - ("auto" === l.slidesPerView ? i.slidesPerViewDynamic() : Math.ceil(parseFloat(l.slidesPerView, 10)))
                      }), r.currentTranslate < i.maxTranslate()) && (e = !1, l.resistance) && (r.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - r.startTranslate - s) ** t), e && (a.preventedByNestedSwiper = !0), !i.allowSlideNext && "next" === i.swipeDirection && r.currentTranslate < r.startTranslate && (r.currentTranslate = r.startTranslate), !i.allowSlidePrev && "prev" === i.swipeDirection && r.currentTranslate > r.startTranslate && (r.currentTranslate = r.startTranslate), i.allowSlidePrev || i.allowSlideNext || (r.currentTranslate = r.startTranslate), 0 < l.threshold) {
                        if (!(Math.abs(s) > l.threshold || r.allowThresholdMove)) return void (r.currentTranslate = r.startTranslate);
              ...
              } else a.target.matches(r.focusableElements) || (i.allowClick = !1), r.isTouched && (Object.assign(n, {
                startX: t,
                startY: d,
                currentX: t,
                currentY: d
              }), r.touchStartTime = g())
            } else r.startMoving && r.isScrolling && i.emit("touchMoveOpposite", a)
          }
          ...
          if ("touchend" === (l = l.originalEvent ? l.originalEvent : l).type || "touchcancel" === l.type) {
            if (!(e = [...l.changedTouches].filter(e => e.identifier === t.touchId)[0]) || e.identifier !== t.touchId) return
          } else {
          ...
          if (!["pointercancel", "pointerout", "pointerleave", "contextmenu"].includes(l.type) || ["pointercancel", "contextmenu"].includes(l.type) && (r.browser.isSafari || r.browser.isWebView)) {
            ...
            if (d && (n.simulateTouch || "mouse" !== l.pointerType)) if (t.allowTouchCallbacks && r.emit("touchEnd", l), t.allowTouchCallbacks = !1, t.isTouched) {
              n.grabCursor && t.isMoved && t.isTouched && (!0 === r.allowSlideNext || !0 === r.allowSlidePrev) && r.setGrabCursor(!1);
              var c, d = g(), p = d - t.touchStartTime;
              if (r.allowClick) {
                const i = l.path || l.composedPath && l.composedPath();
                r.updateClickedSlide(i && i[0] || l.target, i), r.emit("tap click", l), p < 300 && d - t.lastClickTime < 300 && r.emit("doubleTap doubleClick", l)
              }
          ...
          var e = this, {wrapperEl: t, rtlTranslate: s, enabled: a} = e;
          a && (e.previousTranslate = e.translate, e.isHorizontal() ? e.translate = -t.scrollLeft : e.translate = -t.scrollTop, 0 === e.translate && (e.translate = 0), e.updateActiveIndex(), e.updateSlidesClasses(), (0 == (a = e.maxTranslate() - e.minTranslate()) ? 0 : (e.translate - e.minTranslate()) / a) !== e.progress && e.updateProgress(s ? -e.translate : e.translate), e.emit("setTranslate", e.translate, !1))
      ...
      setBreakpoint: function () {
        ...
        if (r && 0 !== Object.keys(r).length) {
          ...
          if (l && a.currentBreakpoint !== l) {
            const p = (l in r ? r[l] : void 0) || a.originalParams, u = _(a, i), m = _(a, p), h = i.enabled;
            ...
            var n = p.direction && p.direction !== i.direction,
              ...
              n = (n && t && a.changeDirection(), f(a.params, p), a.params.enabled), c = a.params.loop;
            Object.assign(a, {
              allowTouchMove: a.params.allowTouchMove,
              allowSlideNext: a.params.allowSlideNext,
              allowSlidePrev: a.params.allowSlidePrev
            }), h && !n ? a.disable() : !h && n && a.enable(), a.currentBreakpoint = l, a.emit("_beforeBreakpoint", p), t && (o ? (a.loopDestroy(), a.loopCreate(e), a.updateSlides()) : !d && c ? (a.loopCreate(e), a.updateSlides()) : d && !c && a.loopDestroy()), a.emit("breakpoint", p)
          }
        }
      }, getBreakpoint: function (e, s, a) {
        if (void 0 === s && (s = "window"), e && ("container" !== s || a)) {
          let t = !1;
          const i = P(), r = "window" === s ? i.innerHeight : a.clientHeight, l = Object.keys(e).map(e => {
            var t;
          ...
          for (let e = 0; e < l.length; e += 1) {
            const {point: P, value: r} = l[e];
            "window" === s ? i.matchMedia(`(min-width: ${r}px)`).matches && (t = P) : r <= a.clientWidth && (t = P)
          }
          return t || "max"
        }
      }
      ...
      checkOverflow: function () {
        const e = this, {isLocked: t, params: s} = e, a = s["slidesOffsetBefore"];
        if (a) {
      ...
      addClasses: function () {
        var {classNames: e, params: t, rtl: s, el: a, device: i} = this, s = function (e, s) {
          const a = [];
          return e.forEach(t => {
        ...
        }(["initialized", t.direction, {"free-mode": this.params.freeMode && t.freeMode.enabled}, {autoheight: t.autoHeight}, {rtl: s}, {grid: t.grid && 1 < t.grid.rows}, {"grid-column": t.grid && 1 < t.grid.rows && "column" === t.grid.fill}, {android: i.android}, {ios: i.ios}, {"css-mode": t.cssMode}, {centered: t.cssMode && t.centeredSlides}, {"watch-progress": t.watchSlidesProgress}], t.containerModifierClass);
  ...
  class u {
    constructor() {
      ...
      1 === a.length && a[0].constructor && "Object" === Object.prototype.toString.call(a[0]).slice(8, -1) ? s = a[0] : [t, s] = a, s = f({}, s = s || {}), t && !s.el && (s.el = t);
      var p, r = A();
      ...
      const l = this,
        n = (l.__swiper__ = !0, l.support = Y(), l.device = (void 0 === (p = {userAgent: s.userAgent}) && (p = {}), y = y || function () {
          var e = (void 0 === p ? {} : p)["userAgent"], t = Y(), s = P(), a = s.navigator.platform,
            e = e || s.navigator.userAgent, i = {ios: !1, android: !1}, r = s.screen.width, s = s.screen.height,
            l = e.match(/(Android);?[\s\/]+([\d.]+)?/);
          let n = e.match(/(iPad).*OS\s([\d_]+)/);
          var o = e.match(/(iPod)(.*OS\s([\d_]+))?/), d = !n && e.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
            c = "Win32" === a, a = "MacIntel" === a;
          return !n && a && t.touch && 0 <= ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(r + "x" + s) && (n = (n = e.match(/(Version)\/([\d.]+)/)) || [0, 1, "13_0_0"]), l && !c && (i.os = "android", i.android = !0), (n || d || o) && (i.os = "ios", i.ios = !0), i
        ...
        }(), l.eventsListeners = {}, l.eventsAnyListeners = [], l.modules = [...l.__modules__], s.modules && Array.isArray(s.modules) && l.modules.push(...s.modules), {});
      l.modules.forEach(e => {
        var a, i;
        e({
          params: s, swiper: l, extendParams: (a = s, i = n, function (e) {
            void 0 === e && (e = {});
          ...
          }), on: l.on.bind(l), once: l.once.bind(l), off: l.off.bind(l), emit: l.emit.bind(l)
        })
      });
      r = f({}, F, n);
      return l.params = f({}, r, c, s), l.originalParams = f({}, l.params), l.passedParams = f({}, s), l.params && l.params.on && Object.keys(l.params.on).forEach(e => {
    ...
    getSlideIndex(e) {
      var {slidesEl: t, params: s} = this, t = x(k(t, `.${s.slideClass}, swiper-slide`)[0]);
      return x(e) - t
    }
    ...
    setProgress(e, t) {
      var s = this, a = (e = Math.min(Math.max(e, 0), 1), s.minTranslate()), e = (s.maxTranslate() - a) * e + a;
    ...
    mount(s) {
      ...
      if (!a.mounted) {
        ...
        !t && a.params.createElements && (t = O("div", a.params.wrapperClass), e.append(t), k(e, "." + a.params.slideClass).forEach(e => {
          t.append(e)
        })), Object.assign(a, {
          el: e,
          wrapperEl: t,
          ...
          rtlTranslate: "horizontal" === a.params.direction && ("rtl" === e.dir.toLowerCase() || "rtl" === C(e, "direction")),
          wrongRTL: "-webkit-box" === C(t, "display")
        })
      }
      return !0
    }
  ...
  function X(s, a, i, r) {
    return s.params.createElements && Object.keys(r).forEach(t => {
      if (!i[t] && !0 === i.auto) {
        let e = k(s.el, "." + r[t])[0];
        e || ((e = O("div", r[t])).className = r[t], s.el.append(e)), i[t] = e, a[t] = e
      }
    }), i
  }
  ...
  function h(e) {
    ...
    if (s.params.virtualTranslate && 0 !== t) {
      ...
      (i ? a : a.filter(e => {
        var t,
          e = e.classList.contains("swiper-slide-transform") ? (t = e).parentElement || s.slides.filter(e => e.shadowRoot && e.shadowRoot === t.parentNode)[0] : e;
  ...
  function S(e, t, s) {
    s = "swiper-slide-shadow" + (s ? "-" + s : "") + (e ? " swiper-slide-shadow-" + e : ""), e = r(t);
    let a = e.querySelector("." + s.split(" ").join("."));
    return a || (a = O("div", s.split(" ")), e.append(a)), a
  }

  return Object.keys(n).forEach(t => {
    Object.keys(n[t]).forEach(e => {
      u.prototype[e] = n[t][e]
    })
  }), u.use([function (e) {
    ...
    t({observer: !1, observeParents: !1, observeSlideChildren: !1}), s("init", () => {
      if (a.params.observer) {
        ...
        r(a.hostEl, {childList: a.params.observeSlideChildren}), r(a.wrapperEl, {attributes: !1})
      }
    }), s("destroy", () => {
      l.forEach(e => {
        e.disconnect()
    ...
    function C(e, t) {
      ...
      let a;
      return s.renderSlide ? "string" == typeof (a = s.renderSlide.call(T, e, t)) && (i.innerHTML = a, a = i.children[0]) : a = T.isElement ? O("swiper-slide") : O("div", T.params.slideClass), a.setAttribute("data-swiper-slide-index", t), s.renderSlide || (a.innerHTML = e), s.cache && (T.virtual.cache[t] = a), a
    }
    ...
    function l(t) {
      ...
      let m, h, f,
        v = (m = T.rtlTranslate ? "right" : T.isHorizontal() ? "left" : "top", u - (f = a ? (h = Math.floor(s / 2) + e + l, Math.floor(s / 2) + e + r) : (h = s + (e - 1) + l, (i ? s : e) + r))),
        g = u + h,
        w = (i || (v = Math.max(v, 0), g = Math.min(g, d.length - 1)), (T.slidesGrid[v] || 0) - (T.slidesGrid[0] || 0));
      ...
      if (i && u >= f ? (v -= f, a || (w += T.slidesGrid[0])) : i && u < f && (v = -f, a) && (w += T.slidesGrid[0]), Object.assign(T.virtual, {
        ...
        slidesBefore: f,
        slidesAfter: h
      }), n !== v || o !== g || t) if (T.params.virtual.renderExternal) T.params.virtual.renderExternal.call(T, {
        offset: w,
        from: v,
        to: g,
        slides: function () {
      ...
      }), T.params.virtual.renderExternalUpdate ? b() : M("virtualUpdate"); else {
        var y = [], E = [], x = e => {
          let t = e;
      ...
      } else T.slidesGrid !== c && w !== p && T.slides.forEach(e => {
        e.style[m] = w - Math.abs(T.cssOverflowAdjustment()) + "px"
    ...
    a("beforeInit", () => {
      if (T.params.virtual.enabled) {
        let e;
        var t;
        void 0 === T.passedParams.virtual.slides && (t = [...T.slidesEl.children].filter(e => e.matches(`.${T.params.slideClass}, swiper-slide`))) && t.length && (T.virtual.slides = [...t], e = !0, t.forEach((e, t) => {
      ...
      T.params.virtual.enabled && T.params.cssMode && L(T.wrapperEl, "--swiper-virtual-size", T.virtualSize + "px")
      ...
      appendSlide: function (t) {
        ...
        if (T.params.virtual.cache) {
          ...
          Object.keys(a).forEach(e => {
            var t = a[e], s = t.getAttribute("data-swiper-slide-index");
    ...
    function a(t) {
      if (p.enabled) {
        ...
        let e = t;
        const a = (e = e.originalEvent ? e.originalEvent : e).keyCode || e.charCode, i = p.params.keyboard.pageUpDown,
          r = i && 33 === a, l = i && 34 === a, n = 37 === a, o = 39 === a, d = 38 === a, c = 40 === a;
        ...
        if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || m.activeElement && m.activeElement.nodeName && ("input" === m.activeElement.nodeName.toLowerCase() || "textarea" === m.activeElement.nodeName.toLowerCase()))) {
          if (p.params.keyboard.onlyInViewport && (r || l || n || o || d || c)) {
            let t = !1;
            if (0 < G(p.el, `.${p.params.slideClass}, swiper-slide`).length && 0 === G(p.el, "." + p.params.slideActiveClass).length) return;
            const e = p.el, a = e.clientWidth, i = e.clientHeight, u = h.innerWidth, m = h.innerHeight, r = D(e),
              l = (s && (r.left -= e.scrollLeft), [[r.left, r.top], [r.left + a, r.top], [r.left, r.top + i], [r.left + a, r.top + i]]);
            for (let e = 0; e < l.length; e += 1) {
              const s = l[e];
    ...
    function n(a) {
      ...
      if (c.enabled && !a.target.closest("." + c.params.mousewheel.noMousewheelClass)) {
        ...
        if ((s = s >= c.minTranslate() ? c.minTranslate() : s) <= c.maxTranslate() && (s = c.maxTranslate()), (r = !!c.params.loop || !(s === c.minTranslate() || s === c.maxTranslate())) && c.params.nested && i.stopPropagation(), c.params.freeMode && c.params.freeMode.enabled) {
    ...
    function o(e) {
      let t = c.el;
      (t = "container" !== c.params.mousewheel.eventsTarget ? document.querySelector(c.params.mousewheel.eventsTarget) : t)[e]("mouseenter", r), t[e]("mouseleave", l), t[e]("wheel", n)
    }
    ...
    function p() {
      const s = i.params.navigation;
      if (i.params.navigation = X(i, i.originalParams.navigation, i.params.navigation, {
        nextEl: "swiper-button-next",
        prevEl: "swiper-button-prev"
      }), s.nextEl || s.prevEl) {
        var e = n(s.nextEl), t = n(s.prevEl);
    ...
    s("init", () => {
      ...
      var {nextEl: s, prevEl: a} = i.navigation, s = l(s), a = l(a), t = t.target;
    ...
    }), d.pagination = {el: null, bullets: []}, 0);
    ...
    function a(e) {
      ...
      t && (e.preventDefault(), e = x(t) * d.params.slidesPerGroup, d.params.loop ? d.realIndex !== e && d.slideToLoop(e) : d.slideTo(e))
    }
    ...
    function l() {
      ...
      if (!r()) {
        ...
        if (d.params.loop ? (e = d.previousRealIndex || 0, r = 1 < d.params.slidesPerGroup ? Math.floor(d.realIndex / d.params.slidesPerGroup) : d.realIndex) : void 0 !== d.snapIndex ? (r = d.snapIndex, e = d.previousSnapIndex) : (e = d.previousIndex || 0, r = d.activeIndex || 0), "bullets" === n.type && d.pagination.bullets && 0 < d.pagination.bullets.length) {
          ...
          let s, a, i;
          if (n.dynamicBullets && (p = H(c[0], d.isHorizontal() ? "width" : "height", !0), t.forEach(e => {
            e.style[d.isHorizontal() ? "width" : "height"] = p * (n.dynamicMainBullets + 4) + "px"
          }), 1 < n.dynamicMainBullets && void 0 !== e && ((u += r - (e || 0)) > n.dynamicMainBullets - 1 ? u = n.dynamicMainBullets - 1 : u < 0 && (u = 0)), s = Math.max(r - u, 0), a = s + (Math.min(c.length, n.dynamicMainBullets) - 1), i = (a + s) / 2), c.forEach(e => {
            ...
            var t = x(e);
            t === r ? e.classList.add(...n.bulletActiveClass.split(" ")) : d.isElement && e.setAttribute("part", "bullet"), n.dynamicBullets && (t >= s && t <= a && e.classList.add(...(n.bulletActiveClass + "-main").split(" ")), t === s && m(e, "prev"), t === a) && m(e, "next")
          }); else {
            const l = c[r];
        ...
        t.forEach((e, a) => {
          if ("fraction" === n.type && (e.querySelectorAll(q(n.currentClass)).forEach(e => {
            ...
            const a = (r + 1) / o;
            let t = 1, s = 1;
            "horizontal" == i ? t = a : s = a, e.querySelectorAll(q(n.progressbarFillClass)).forEach(e => {
    ...
    function h() {
      const t = d.params.pagination;
      var e;
      r() || ((e = d.pagination.el) && (e = i(e)).forEach(e => {
    ...
    s("changeDirection", () => {
      ...
      (!1 === d.params.pagination.enabled ? f : (o(), n(), l))()
    }), s("activeIndexChange", () => {
      void 0 === d.snapIndex && l()
    }), s("snapIndexChange", () => {
      l()
      ...
      var e = d.pagination["el"];
      e && (e = i(e)).forEach(e => e.classList[d.enabled ? "remove" : "add"](d.params.pagination.lockClass))
    }), s("lock unlock", () => {
      l()
    }), s("click", (e, t) => {
      var t = t.target, s = i(d.pagination.el);
      if (d.params.pagination.el && d.params.pagination.hideOnClick && s && 0 < s.length && !t.classList.contains(d.params.pagination.bulletClass) && (!d.navigation || !(d.navigation.nextEl && t === d.navigation.nextEl || d.navigation.prevEl && t === d.navigation.prevEl))) {
        ...
        c(!0 === e ? "paginationShow" : "paginationHide"), s.forEach(e => e.classList.toggle(d.params.pagination.hiddenClass))
      }
    });
    const f = () => {
    ...
    Object.assign(d.pagination, {
      enable: () => {
        ...
        var e = d.pagination["el"];
        e && (e = i(e)).forEach(e => e.classList.remove(d.params.pagination.paginationDisabledClass)), o(), n(), l()
      }, disable: f, render: n, update: l, init: o, destroy: h
    })
  }, function (e) {
    let {swiper: o, extendParams: t, on: s, emit: r} = e;
    const l = A();
    let n, d, c, a, p = !1, u = null, m = null;
    ...
    function i() {
      if (o.params.scrollbar.el && o.scrollbar.el) {
        ...
        let e = d, t = (c - d) * n;
        a ? 0 < (t = -t) ? (e = d - t, t = 0) : -t + d > c && (e = c + t) : t < 0 ? (e = d + t, t = 0) : t + d > c && (e = c - t), o.isHorizontal() ? (i.style.transform = `translate3d(${t}px, 0, 0)`, i.style.width = e + "px") : (i.style.transform = `translate3d(0px, ${t}px, 0)`, i.style.height = e + "px"), l.hide && (clearTimeout(u), r.style.opacity = 1, u = setTimeout(() => {
    ...
    function v(e) {
      var {scrollbar: t, rtlTranslate: s} = o, t = t["el"];
      let a;
      a = (f(e) - D(t)[o.isHorizontal() ? "left" : "top"] - (null !== n ? n : d / 2)) / (c - d), a = Math.max(Math.min(a, 1), 0), s && (a = 1 - a);
    ...
    function g(e) {
      var t = o.params.scrollbar, {scrollbar: s, wrapperEl: a} = o, {el: s, dragEl: i} = s;
      p = !0, n = e.target === i ? f(e) - e.target.getBoundingClientRect()[o.isHorizontal() ? "left" : "top"] : null, e.preventDefault(), e.stopPropagation(), a.style.transitionDuration = "100ms", i.style.transitionDuration = "100ms", v(e), clearTimeout(m), s.style.transitionDuration = "0ms", t.hide && (s.style.opacity = 1), o.params.cssMode && (o.wrapperEl.style["scroll-snap-type"] = "none"), r("scrollbarDragStart", e)
    }

    function w(e) {
      var {scrollbar: t, wrapperEl: s} = o, {el: t, dragEl: a} = t;
      p && (e.preventDefault ? e.preventDefault() : e.returnValue = !1, v(e), s.style.transitionDuration = "0ms", t.style.transitionDuration = "0ms", a.style.transitionDuration = "0ms", r("scrollbarDragMove", e))
    }

    function b(e) {
      const t = o.params.scrollbar, {scrollbar: s, wrapperEl: a} = o, i = s["el"];
      p && (p = !1, o.params.cssMode && (o.wrapperEl.style["scroll-snap-type"] = "", a.style.transitionDuration = ""), t.hide && (clearTimeout(m), m = M(() => {
    ...
    function y(e) {
      ...
      s && (t = !!a.passiveListeners && {passive: !1, capture: !1}, a = !!a.passiveListeners && {
        passive: !0,
        capture: !1
      }, s = s) && (s[s = "on" === e ? "addEventListener" : "removeEventListener"]("pointerdown", g, t), l[s]("pointermove", w, t), l[s]("pointerup", b, a))
    }

    function E() {
      var {scrollbar: s, el: a} = o,
        i = (o.params.scrollbar = X(o, o.originalParams.scrollbar, o.params.scrollbar, {el: "swiper-scrollbar"}), o.params.scrollbar);
      if (i.el) {
        let e, t;
        if ((e = "string" == typeof i.el && o.isElement ? o.el.querySelector(i.el) : e) || "string" != typeof i.el) e = e || i.el; else if (!(e = l.querySelectorAll(i.el)).length) return;
        (e = 0 < (e = o.params.uniqueNavElements && "string" == typeof i.el && 1 < e.length && 1 === a.querySelectorAll(i.el).length ? a.querySelector(i.el) : e).length ? e[0] : e).classList.add(o.isHorizontal() ? i.horizontalClass : i.verticalClass), e && ((t = e.querySelector(q(o.params.scrollbar.dragClass))) || (t = O("div", o.params.scrollbar.dragClass), e.append(t))), Object.assign(s, {
          el: e,
          dragEl: t
    ...
    Object.assign(o.scrollbar, {
      enable: () => {
        o.el.classList.remove(...T(o.params.scrollbar.scrollbarDisabledClass)), o.scrollbar.el && o.scrollbar.el.classList.remove(...T(o.params.scrollbar.scrollbarDisabledClass)), E(), h(), i()
      }, disable: S, updateSize: h, setTranslate: i, init: E, destroy: x
    })
  }, function (e) {
    ...
    const r = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
      l = (e, t) => {
        var s = c["rtl"], s = s ? -1 : 1, a = e.getAttribute("data-swiper-parallax") || "0";
        let i = e.getAttribute("data-swiper-parallax-x"), r = e.getAttribute("data-swiper-parallax-y");
        var l = e.getAttribute("data-swiper-parallax-scale"), n = e.getAttribute("data-swiper-parallax-opacity"),
          o = e.getAttribute("data-swiper-parallax-rotate");
        if (i || r ? (i = i || "0", r = r || "0") : c.isHorizontal() ? (i = a, r = "0") : (r = a, i = "0"), i = 0 <= i.indexOf("%") ? parseInt(i, 10) * t * s + "%" : i * t * s + "px", r = 0 <= r.indexOf("%") ? parseInt(r, 10) * t + "%" : r * t + "px", null != n) {
          const c = n - (n - 1) * (1 - Math.abs(t));
          e.style.opacity = c
        }
        let d = `translate3d(${i}, ${r}, 0px)`;
        null != l && (d += ` scale(${l - (l - 1) * (1 - Math.abs(t))})`), o && null != o && (d += ` rotate(${o * t * -1}deg)`), e.style.transform = d
      }, a = () => {
        const {el: e, slides: t, progress: a, snapGrid: i} = c, s = k(e, r);
        c.isElement && s.push(...k(c.hostEl, r)), s.forEach(e => {
          l(e, a)
        }), t.forEach((e, t) => {
          let s = e.progress;
          1 < c.params.slidesPerGroup && "auto" !== c.params.slidesPerView && (s += Math.ceil(t / 2) - a * (i.length - 1)), s = Math.min(Math.max(s, -1), 1), e.querySelectorAll(r + ", [data-swiper-parallax-rotate]").forEach(e => {
            l(e, s)
          })
        })
      };
    s("beforeInit", () => {
      ...
      c.params.parallax.enabled && ({
        el: t,
        hostEl: a
      } = (void 0 === (s = t) && (s = c.params.speed), c), t = [...t.querySelectorAll(r)], c.isElement && t.push(...a.querySelectorAll(r)), t.forEach(e => {
    ...
    function c() {
      var e, t, s, a;
      return n.length < 2 ? 1 : (e = n[0].pageX, t = n[0].pageY, s = n[1].pageX, a = n[1].pageY, Math.sqrt((s - e) ** 2 + (a - t) ** 2))
    }
      ...
      if ("mouse" === t.pointerType && n.splice(0, n.length), p(t)) {
        ...
        if (i = !1, r = !1, n.push(t), !(n.length < 2)) {
          if (i = !0, M.scaleStart = c(), !M.slideEl) {
            ...
            if (e = e && e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0], M.imageEl = e, M.imageWrapEl = e ? G(M.imageEl, "." + s.containerClass)[0] : void 0, !M.imageWrapEl) return void (M.imageEl = void 0);
            M.maxRatio = M.imageWrapEl.getAttribute("data-swiper-zoom") || s.maxRatio
          }
          if (M.imageEl) {
            const [t, x] = n.length < 2 ? {
              x: null,
              y: null
            } : (s = M.imageEl.getBoundingClientRect(), [(n[0].pageX + (n[1].pageX - n[0].pageX) / 2 - s.x - S.scrollX) / T, (n[0].pageY + (n[1].pageY - n[0].pageY) / 2 - s.y - S.scrollY) / T]);
    ...
    function f(e) {
      if (p(e) && (t = e, s = "." + x.params.zoom.containerClass, t.target.matches(s) || 0 < [...x.hostEl.querySelectorAll(s)].filter(e => e.contains(t.target)).length)) {
        ...
        if (M.imageEl && C.isTouched && M.slideEl) {
          ...
          var a = C.width * s.scale, i = C.height * s.scale;
          if (!(a < M.slideWidth && i < M.slideHeight)) {
            if (C.minX = Math.min(M.slideWidth / 2 - a / 2, 0), C.maxX = -C.minX, C.minY = Math.min(M.slideHeight / 2 - i / 2, 0), C.maxY = -C.minY, C.touchesCurrent.x = (0 < n.length ? n[0] : e).pageX, C.touchesCurrent.y = (0 < n.length ? n[0] : e).pageY, 5 < Math.max(Math.abs(C.touchesCurrent.x - C.touchesStart.x), Math.abs(C.touchesCurrent.y - C.touchesStart.y)) && (x.allowClick = !1), !C.isMoved && !l) {
            ...
            var a = (s.scale - T) / (M.maxRatio - x.params.zoom.minRatio), {originX: i, originY: e} = M;
    ...
    function g(w) {
      var b = x.zoom, y = x.params.zoom;
      if (!M.slideEl) {
        w && w.target && (M.slideEl = w.target.closest(`.${x.params.slideClass}, swiper-slide`)), M.slideEl || (x.params.virtual && x.params.virtual.enabled && x.virtual ? M.slideEl = k(x.slidesEl, "." + x.params.slideActiveClass)[0] : M.slideEl = x.slides[x.activeIndex]);
        let e = M.slideEl.querySelector("." + y.containerClass);
        e = e && e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0], M.imageEl = e, M.imageWrapEl = e ? G(M.imageEl, "." + y.containerClass)[0] : void 0
      }
      if (M.imageEl && M.imageWrapEl) {
        ...
        1 === T && E && (e = void 0, t = void 0), b.scale = E || M.imageWrapEl.getAttribute("data-swiper-zoom") || y.maxRatio, T = E || M.imageWrapEl.getAttribute("data-swiper-zoom") || y.maxRatio, !w || 1 === T && E ? (l = 0, n = 0) : (v = M.slideEl.offsetWidth, g = M.slideEl.offsetHeight, s = D(M.slideEl).left + S.scrollX, a = D(M.slideEl).top + S.scrollY, i = s + v / 2 - e, r = a + g / 2 - t, o = M.imageEl.offsetWidth, d = M.imageEl.offsetHeight, c = o * b.scale, p = d * b.scale, h = -(u = Math.min(v / 2 - c / 2, 0)), f = -(m = Math.min(g / 2 - p / 2, 0)), l = i * b.scale, n = r * b.scale, (l = l < u ? u : l) > h && (l = h), (n = n < m ? m : n) > f && (n = f)), E && 1 === b.scale && (M.originX = 0, M.originY = 0), M.imageWrapEl.style.transitionDuration = "300ms", M.imageWrapEl.style.transform = `translate3d(${l}px, ${n}px,0)`, M.imageEl.style.transitionDuration = "300ms", M.imageEl.style.transform = `translate3d(0,0,0) scale(${b.scale})`
      }
    }
    ...
    function w() {
      ...
      if (!M.slideEl) {
        x.params.virtual && x.params.virtual.enabled && x.virtual ? M.slideEl = k(x.slidesEl, "." + x.params.slideActiveClass)[0] : M.slideEl = x.slides[x.activeIndex];
        let e = M.slideEl.querySelector("." + t.containerClass);
        e = e && e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0], M.imageEl = e, M.imageWrapEl = e ? G(M.imageEl, "." + t.containerClass)[0] : void 0
      }
    ...
    Object.defineProperty(x.zoom, "scale", {
      ...
      var s;
      x.zoom.enabled && (t = t, s = x.device, M.imageEl) && !C.isTouched && (s.android && t.cancelable && t.preventDefault(), C.isTouched = !0, s = 0 < n.length ? n[0] : t, C.touchesStart.x = s.pageX, C.touchesStart.y = s.pageY)
    }), s("touchEnd", (e, t) => {
      if (x.zoom.enabled) {
        var s = x.zoom;
        if (M.imageEl) {
          ...
          let e = 300, t = 300;
          var a = o.x * e, a = C.currentX + a, i = o.y * t, i = C.currentY + i,
            r = (0 !== o.x && (e = Math.abs((a - C.currentX) / o.x)), 0 !== o.y && (t = Math.abs((i - C.currentY) / o.y)), Math.max(e, t)),
            a = (C.currentX = a, C.currentY = i, C.width * s.scale), i = C.height * s.scale;
          C.minX = Math.min(M.slideWidth / 2 - a / 2, 0), C.maxX = -C.minX, C.minY = Math.min(M.slideHeight / 2 - i / 2, 0), C.maxY = -C.minY, C.currentX = Math.max(Math.min(C.currentX, C.maxX), C.minX), C.currentY = Math.max(Math.min(C.currentY, C.maxY), C.minY), M.imageWrapEl.style.transitionDuration = r + "ms", M.imageWrapEl.style.transform = `translate3d(${C.currentX}px, ${C.currentY}px,0)`
        }
      }
    }), s("doubleTap", (e, t) => {
    ...
    }), Object.assign(x.zoom, {enable: E, disable: L, in: g, out: w, toggle: b})
  }, function (e) {
    ...
    let {swiper: n, extendParams: t, on: s} = e, o = (t({
      a11y: {
        enabled: !0,
    ...
    function h(e) {
      var t, s;
      13 !== e.keyCode && 32 !== e.keyCode || (t = n.params.a11y, s = e.target, n.pagination && n.pagination.el && (s === n.pagination.el || n.pagination.el.contains(e.target)) && !e.target.matches(q(n.params.pagination.bulletClass))) || (n.navigation && n.navigation.nextEl && s === n.navigation.nextEl && (n.isEnd && !n.params.loop || n.slideNext(), n.isEnd ? a(t.lastSlideMessage) : a(t.nextSlideMessage)), n.navigation && n.navigation.prevEl && s === n.navigation.prevEl && (n.isBeginning && !n.params.loop || n.slidePrev(), n.isBeginning ? a(t.firstSlideMessage) : a(t.prevSlideMessage)), n.pagination && s.matches(q(n.params.pagination.bulletClass)) && s.click())
    }
    ...
    const g = (e, t, s) => {
      var a;
      i(e), "BUTTON" !== e.tagName && (l(e, "button"), e.addEventListener("keydown", h)), p(e, s), s = e, a = t, (s = d(s)).forEach(e => {
      ...
      var t, s, a;
      n.a11y.clicked || (t = e.target.closest(`.${n.params.slideClass}, swiper-slide`)) && n.slides.includes(t) && (s = n.slides.indexOf(t) === n.activeIndex, a = n.params.watchSlidesProgress && n.visibleSlides && n.visibleSlides.includes(t), s || a || e.sourceCapabilities && e.sourceCapabilities.firesTouchEvents || (n.isHorizontal() ? n.el.scrollLeft = 0 : n.el.scrollTop = 0, n.slideTo(n.slides.indexOf(t), 0)))
    }, E = () => {
      const s = n.params.a11y,
        a = (s.itemRoleDescriptionMessage && c(n.slides, s.itemRoleDescriptionMessage), s.slideRole && l(n.slides, s.slideRole), n.slides.length);
      s.slideLabelMessage && n.slides.forEach((e, t) => {
        t = n.params.loop ? parseInt(e.getAttribute("data-swiper-slide-index"), 10) : t;
        p(e, s.slideLabelMessage.replace(/\{\{index\}\}/, t + 1).replace(/\{\{slidesLength\}\}/, a))
      })
    };
    s("beforeInit", () => {
      (o = O("span", n.params.a11y.notificationClass)).setAttribute("aria-live", "assertive"), o.setAttribute("aria-atomic", "true")
    }), s("afterInit", () => {
      if (n.params.a11y.enabled) {
        const i = n.params.a11y;
        n.el.append(o);
        var e = n.el;
        i.containerRoleDescriptionMessage && c(e, i.containerRoleDescriptionMessage), i.containerMessage && p(e, i.containerMessage);
        const r = n.wrapperEl,
          l = i.id || r.getAttribute("id") || "swiper-wrapper-" + "x".repeat(e = void 0 === (e = 16) ? 16 : e).replace(/x/g, () => Math.round(16 * Math.random()).toString(16));
        var t, e = n.params.autoplay && n.params.autoplay.enabled ? "off" : "polite", s = l, {
          nextEl: e,
          prevEl: a
        } = (d(r).forEach(e => {
          e.setAttribute("id", s)
        }), a = r, t = e, (a = d(a)).forEach(e => {
          e.setAttribute("aria-live", t)
        }), E(), n.navigation || {}), e = d(e), a = d(a);
        e && e.forEach(e => g(e, l, i.nextSlideMessage)), a && a.forEach(e => g(e, l, i.prevSlideMessage)), v() && d(n.pagination.el).forEach(e => {
          e.addEventListener("keydown", h)
        }), n.el.addEventListener("focus", y, !0), n.el.addEventListener("pointerdown", w, !0), n.el.addEventListener("pointerup", b, !0)
      }
      ...
      n.params.a11y.enabled && !n.params.loop && !n.params.rewind && n.navigation && ({
        nextEl: e,
        prevEl: t
      } = n.navigation, t && (n.isBeginning ? (u(t), r) : (m(t), i))(t), e) && (n.isEnd ? (u(e), r) : (m(e), i))(e)
    }), s("paginationUpdate", () => {
      if (n.params.a11y.enabled) {
        const t = n.params.a11y;
        f() && n.pagination.bullets.forEach(e => {
          n.params.pagination.clickable && (i(e), n.params.pagination.renderBullet || (l(e, "button"), p(e, t.paginationBulletMessage.replace(/\{\{index\}\}/, x(e) + 1)))), e.matches(q(n.params.pagination.bulletActiveClass)) ? e.setAttribute("aria-current", "true") : e.removeAttribute("aria-current")
        })
      }
    }), s("destroy", () => {
      var e, t;
      n.params.a11y.enabled && (o && o.remove(), {
        nextEl: e,
        prevEl: t
      } = n.navigation || {}, e = d(e), t = d(t), e && e.forEach(e => e.removeEventListener("keydown", h)), t && t.forEach(e => e.removeEventListener("keydown", h)), v() && d(n.pagination.el).forEach(e => {
        e.removeEventListener("keydown", h)
      }), n.el.removeEventListener("focus", y, !0), n.el.removeEventListener("pointerdown", w, !0), n.el.removeEventListener("pointerup", b, !0))
    })
  }, function (e) {
    let {swiper: l, extendParams: t, on: s} = e,
      r = (t({history: {enabled: !1, root: "", replaceState: !1, key: "slides", keepQuery: !1}}), !1), a = {};
    const n = e => e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
      i = e => {
        var t = P(), e = (e ? new URL(e) : t.location).pathname.slice(1).split("/").filter(e => "" !== e), t = e.length;
        return {key: e[t - 2], value: e[t - 1]}
      }, o = (s, e) => {
        var a = P();
        if (r && l.params.history.enabled) {
          var i = l.params.url ? new URL(l.params.url) : a.location, e = l.slides[e];
          ...
          } else i.pathname.includes(s) || (t = (s ? s + "/" : "") + t);
          l.params.history.keepQuery && (t += i.search);
          e = a.history.state;
          e && e.value === t || (l.params.history.replaceState ? a.history.replaceState({value: t}, null, t) : a.history.pushState({value: t}, null, t))
        }
      }, d = (s, a, i) => {
    ...
    s("init", () => {
      var e;
      l.params.history.enabled && (e = P(), l.params.history) && (e.history && e.history.pushState ? (r = !0, ((a = i(l.params.url)).key || a.value) && d(0, a.value, l.params.runCallbacksOnInit), l.params.history.replaceState || e.addEventListener("popstate", c)) : (l.params.history.enabled = !1, l.params.hashNavigation.enabled = !0))
    }), s("destroy", () => {
      var e;
      l.params.history.enabled && (e = P(), l.params.history.replaceState || e.removeEventListener("popstate", c))
    ...
    const l = A(), n = P(), o = (t({
      hashNavigation: {
        enabled: !1, replaceState: !1, watchState: !1, getSlideIndex(e, t) {
          ...
          return s.getSlideIndex(k(s.slidesEl, `.${s.params.slideClass}[data-hash="${t}"], swiper-slide[data-hash="${t}"]`)[0])
        }
      }
    }), () => {
      a("hashChange");
      ...
      var e;
      r && s.params.hashNavigation.enabled && (e = (e = s.virtual && s.params.virtual.enabled ? s.slidesEl.querySelector(`[data-swiper-slide-index="${s.activeIndex}"]`) : s.slides[s.activeIndex]) ? e.getAttribute("data-hash") || e.getAttribute("data-history") : "", s.params.hashNavigation.replaceState && n.history && n.history.replaceState ? n.history.replaceState(null, null, "#" + e || "") : l.location.hash = e || "", a("hashSet"))
    };
    i("init", () => {
      var e;
      !s.params.hashNavigation.enabled || !s.params.hashNavigation.enabled || s.params.history && s.params.history.enabled || (r = !0, (e = l.location.hash.replace("#", "")) && (e = s.params.hashNavigation.getSlideIndex(s, e), s.slideTo(e || 0, 0, s.params.runCallbacksOnInit, !0)), s.params.hashNavigation.watchState && n.addEventListener("hashchange", o))
    }), i("destroy", () => {
    ...
    const y = () => {
      ...
      !n.destroyed && n.autoplay.running && (clearTimeout(r), e || (h = !0), e = () => {
        o("autoplayPause"), n.params.autoplay.waitForTransition ? n.wrapperEl.addEventListener("transitionend", b) : M()
      }, n.autoplay.paused = !0, t ? (m && (d = n.params.autoplay.delay), m = !1, e()) : (t = d || n.params.autoplay.delay, d = t - ((new Date).getTime() - w), n.isEnd && d < 0 && !n.params.loop || (d < 0 && (d = 0), e())))
    }, M = () => {
    ...
    s("init", () => {
      n.params.autoplay.enabled && (n.params.autoplay.pauseOnMouseEnter && (n.el.addEventListener("pointerenter", L), n.el.addEventListener("pointerleave", P)), A().addEventListener("visibilitychange", C), x())
    }), s("destroy", () => {
      n.el.removeEventListener("pointerenter", L), n.el.removeEventListener("pointerleave", P), A().removeEventListener("visibilitychange", C), n.autoplay.running && S()
      ...
      !n.destroyed && n.autoplay.running && c && (clearTimeout(u), clearTimeout(r), c = (p = (n.params.autoplay.disableOnInteraction || p && n.params.cssMode && M(), !1), !1))
    }), s("slideChange", () => {
      !n.destroyed && n.autoplay.running && (m = !0)
    }), Object.assign(n.autoplay, {start: x, stop: S, pause: T, resume: M})
  }, function (e) {
    let {swiper: o, extendParams: t, on: s} = e, a = (t({
      thumbs: {
        swiper: null,
    ...
    function r() {
      ...
      !s || s.destroyed || (e = s.clickedIndex, (t = s.clickedSlide) && t.classList.contains(o.params.thumbs.slideThumbActiveClass)) || null != e && (t = s.params.loop ? parseInt(s.clickedSlide.getAttribute("data-swiper-slide-index"), 10) : e, o.params.loop ? o.slideToLoop(t) : o.slideTo(t))
    }
    ...
    t({
      ...
      freeMode: {
        onTouchStart: function () {
          var e;
          u.params.cssMode || (e = u.getTranslate(), u.setTranslate(e), u.setTransition(0), u.touchEventsData.velocities.length = 0, u.freeMode.onTouchEnd({currentPos: u.rtl ? u.translate : -u.translate}))
          ...
          }), e.velocities.push({position: t[u.isHorizontal() ? "currentX" : "currentY"], time: g()}))
        }, onTouchEnd: function (r) {
          let l = r["currentPos"];
          if (!u.params.cssMode) {
            const {params: n, wrapperEl: o, rtlTranslate: d, snapGrid: c, touchEventsData: p} = u,
              e = g() - p.touchStartTime;
            if (l < -u.minTranslate()) u.slideTo(u.activeIndex); else if (l > -u.maxTranslate()) u.slides.length < c.length ? u.slideTo(c.length - 1) : u.slideTo(u.slides.length - 1); else {
              if (n.freeMode.momentum) {
                if (1 < p.velocities.length) {
                  const r = p.velocities.pop(), l = p.velocities.pop(), m = r.position - l.position,
                    h = r.time - l.time;
                  u.velocity = m / h, u.velocity /= 2, Math.abs(u.velocity) < n.freeMode.minimumVelocity && (u.velocity = 0), (150 < h || 300 < g() - r.time) && (u.velocity = 0)
                } else u.velocity = 0;
                ...
                let i;
                if (s < u.maxTranslate()) n.freeMode.momentumBounce ? (s + u.maxTranslate() < -r && (s = u.maxTranslate() - r), t = u.maxTranslate(), a = !0, p.allowMomentumBounce = !0) : s = u.maxTranslate(), n.loop && n.centeredSlides && (i = !0); else if (s > u.minTranslate()) n.freeMode.momentumBounce ? (s - u.minTranslate() > r && (s = u.minTranslate() + r), t = u.minTranslate(), a = !0, p.allowMomentumBounce = !0) : s = u.minTranslate(), n.loop && n.centeredSlides && (i = !0); else if (n.freeMode.sticky) {
                  let t;
                ...
                if (i && h("transitionEnd", () => {
                  ...
                  if (e = d ? Math.abs((-s - u.translate) / u.velocity) : Math.abs((s - u.translate) / u.velocity), n.freeMode.sticky) {
                    const l = Math.abs((d ? -s : s) - u.translate), m = u.slidesSizesGrid[u.activeIndex];
                    e = l < m ? n.speed : l < 2 * m ? 1.5 * n.speed : 2.5 * n.speed
                  }
                } else if (n.freeMode.sticky) return void u.slideToClosest();
                n.freeMode.momentumBounce && a ? (u.updateProgress(t), u.setTransition(e), u.setTranslate(s), u.transitionStart(!0, u.swipeDirection), u.animating = !0, v(o, () => {
                  u && !u.destroyed && p.allowMomentumBounce && (m("momentumBounce"), u.setTransition(n.speed), setTimeout(() => {
                    u.setTranslate(t), v(o, () => {
                      u && !u.destroyed && u.transitionEnd()
                    })
                  }, 0))
                })) : u.velocity ? (m("_freeModeNoMomentumRelease"), u.updateProgress(s), u.setTransition(e), u.setTranslate(s), u.transitionStart(!0, u.swipeDirection), u.animating || (u.animating = !0, v(o, () => {
                  u && !u.destroyed && u.transitionEnd()
                }))) : u.updateProgress(s), u.updateActiveIndex(), u.updateSlidesClasses()
              } else {
                if (n.freeMode.sticky) return void u.slideToClosest();
                n.freeMode && m("_freeModeNoMomentumRelease")
              }
              (!n.freeMode.momentum || e >= n.longSwipesMs) && (m("_freeModeStaticRelease"), u.updateProgress(), u.updateActiveIndex(), u.updateSlidesClasses())
            }
          }
        }
      }
    ...
    s("init", () => {
      ...
      var {params: e, el: t} = m, s = e.grid && 1 < e.grid.rows;
      ...
      initSlides: e => {
        var t = m.params["slidesPerView"], {rows: s, fill: a} = m.params.grid,
        ...
        var a = m.params["slidesPerGroup"], i = h(), {rows: r, fill: l} = m.params.grid,
        ...
        if ("row" === l && 1 < a) {
          ...
          d = Math.floor(u / m), n = (o = u - d * m + p * a) + d * c / r, t.style.order = n
        } else "column" === l ? (o = Math.floor(e / r), d = e - o * r, (o > u || o === u && d === r - 1) && (d += 1) >= r && (d = 0, o += 1)) : (d = Math.floor(e / p), o = e - d * p);
        ...
        var {centeredSlides: e, roundLengths: i} = m.params, t = h(), r = m.params.grid["rows"];
    ...
    Object.assign(e, {
      appendSlide: function (t) {
        ...
        var i = e => {
          var t;
          "string" == typeof e ? ((t = document.createElement("div")).innerHTML = e, a.append(t.children[0]), t.innerHTML = "") : a.append(e)
        };
      ...
      }.bind(e), addSlide: function (t, s) {
        var a = this, {params: i, activeIndex: r, slidesEl: l} = a;
        let n = r;
        if (i.loop && (n -= a.loopedSlides, a.loopDestroy(), a.recalcSlides()), r = a.slides.length, t <= 0) a.prependSlide(s); else if (r <= t) a.appendSlide(s); else {
          let e = n > t ? n + 1 : n;
          var o = [];
          for (let e = r - 1; e >= t; --e) {
            const t = a.slides[e];
          ...
          if ("object" == typeof s && "length" in s) {
            for (let e = 0; e < s.length; e += 1) s[e] && l.append(s[e]);
            e = n > t ? n + s.length : n
          } else l.append(s);
        ...
        let r, l = i;
        if ("object" == typeof t && "length" in t) for (let e = 0; e < t.length; e += 1) r = t[e], s.slides[r] && s.slides[r].remove(), r < l && --l; else r = t, s.slides[r] && s.slides[r].remove(), r < l && --l;
        l = Math.max(l, 0), s.recalcSlides(), e.loop && s.loopCreate(), e.observer && !s.isElement || s.update(), e.loop ? s.slideTo(l + s.loopedSlides, 0, !1) : s.slideTo(l, 0, !1)
    ...
    t({fadeEffect: {crossFade: !1}}), m({
      ...
      setTranslate: () => {
        ...
        for (let s = 0; s < a.length; s += 1) {
          const a = l.slides[s];
          let e = -a.swiperSlideOffset, t = (l.params.virtualTranslate || (e -= l.translate), 0);
          l.isHorizontal() || (t = e, e = 0);
          var i = l.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(a.progress), 0) : 1 + Math.min(Math.max(a.progress, -1), 0),
            r = E(0, a);
      ...
      setTransition: t => {
        ...
        }), h({swiper: l, duration: t, transformElements: e, allSlides: !0})
      },
      overwriteParams: () => ({
        slidesPerView: 1,
        slidesPerGroup: 1,
    ...
    const w = (e, t, s) => {
      ...
      a || (a = O("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "left" : "top")).split(" ")), e.append(a)), i || (i = O("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "right" : "bottom")).split(" ")), e.append(i)), a && (a.style.opacity = Math.max(-t, 0)), i && (i.style.opacity = Math.max(t, 0))
    };
    m({
      effect: "cube",
      swiper: g,
      ...
      setTranslate: () => {
        ...
        for (let l = 0; l < o.length; l += 1) {
          const n = o[l];
          let e = l, t = 90 * (e = m ? parseInt(n.getAttribute("data-swiper-slide-index"), 10) : e),
            s = Math.floor(t / 360);
        ...
        if (n.style.transformOrigin = `50% 50% -${c / 2}px`, n.style["-webkit-transform-origin"] = `50% 50% -${c / 2}px`, p.shadow) if (u) h.style.transform = `translate3d(0px, ${t / 2 + p.shadowOffset}px, ${-t / 2}px) rotateX(89.99deg) rotateZ(0deg) scale(${p.shadowScale})`; else {
          const e = Math.abs(f) - 90 * Math.floor(Math.abs(f) / 90),
            g = 1.5 - (Math.sin(2 * e * Math.PI / 360) / 2 + Math.cos(2 * e * Math.PI / 360) / 2), n = p.shadowScale,
            o = p.shadowScale / g, w = p.shadowOffset;
    ...
    const u = (e, t) => {
      ...
      s = s || S("flip", e, p.isHorizontal() ? "left" : "top"), a = a || S("flip", e, p.isHorizontal() ? "right" : "bottom"), s && (s.style.opacity = Math.max(-t, 0)), a && (a.style.opacity = Math.max(t, 0))
    };
    m({
      effect: "flip",
      swiper: p,
      ...
      setTranslate: () => {
        ...
        for (let r = 0; r < l.length; r += 1) {
          ...
          let t = -180 * e, s = 0, a = p.params.cssMode ? -c - p.translate : -c, i = 0;
          p.isHorizontal() ? n && (t = -t) : (i = a, a = 0, s = -t, t = 0), p.browser && p.browser.isSafari && (Math.abs(t) / 90 % 2 == 1 && (t += .001), Math.abs(s) / 90 % 2 == 1) && (s += .001), d.style.zIndex = -Math.abs(Math.round(e)) + l.length, o.slideShadows && u(d, e);
      ...
      setTransition: t => {
        ...
        }), h({swiper: p, duration: t, transformElements: e})
      },
      recreateShadows: () => {
    ...
    t({coverflowEffect: {rotate: 50, stretch: 0, depth: 100, scale: 1, modifier: 1, slideShadows: !0}}), m({
      effect: "coverflow", swiper: y, on: s, setTranslate: () => {
        const {width: e, height: o, slides: d, slidesSizesGrid: c} = y, p = y.params.coverflowEffect,
          u = y.isHorizontal(), m = y.translate, h = u ? e / 2 - m : o / 2 - m, f = u ? p.rotate : -p.rotate,
          v = p.depth;
        for (let n = 0, e = d.length; n < e; n += 1) {
          ...
          let e = u ? f * b : 0, t = u ? 0 : f * b, s = -v * Math.abs(b), a = p.stretch,
            i = ("string" == typeof a && -1 !== a.indexOf("%") && (a = parseFloat(p.stretch) / 100 * m), u ? 0 : a * b),
            r = u ? a * b : 0, l = 1 - (1 - p.scale) * Math.abs(b);
          ...
          if (E(0, o).style.transform = g, o.style.zIndex = 1 - Math.abs(Math.round(b)), p.slideShadows) {
            ...
            e = e || S("coverflow", o, u ? "left" : "top"), t = t || S("coverflow", o, u ? "right" : "bottom"), e && (e.style.opacity = 0 < b ? b : 0), t && (t.style.opacity = 0 < -b ? -b : 0)
          }
        }
      }, setTransition: t => {
        y.slides.map(e => r(e)).forEach(e => {
          e.style.transitionDuration = t + "ms", e.querySelectorAll(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").forEach(e => {
            e.style.transitionDuration = t + "ms"
          })
        })
    ...
    m({
      ...
      on: s,
      setTranslate: () => {
        const {slides: i, wrapperEl: e, slidesSizesGrid: r} = w, l = w.params.creativeEffect,
          n = l["progressMultiplier"], o = w.params.centeredSlides;
        if (o) {
          const i = r[0] / 2 - w.params.slidesOffsetBefore || 0;
          e.style.transform = `translateX(calc(50% - ${i}px))`
        }
        for (let s = 0; s < i.length; s += 1) {
          const r = i[s], m = r.progress, h = Math.min(Math.max(r.progress, -l.limitProgress), l.limitProgress);
          let e = h;
          ...
          let t = !1, a = (w.isHorizontal() || (v[1] = v[0], v[0] = 0), {
            translate: [0, 0, 0],
            rotate: [0, 0, 0],
            scale: 1,
            opacity: 1
          ...
          h < 0 ? (a = l.next, t = !0) : 0 < h && (a = l.prev, t = !0), v.forEach((e, t) => {
            v[t] = `calc(${e}px + (${e = a.translate[t], "string" == typeof e ? e : e + "px"} * ${Math.abs(h * n)}))`
          }), g.forEach((e, t) => {
            let s = a.rotate[t] * Math.abs(h * n);
            w.browser && w.browser.isSafari && Math.abs(s) / 90 % 2 == 1 && (s += .001), g[t] = s
          ...
          var d = v.join(", "), c = `rotateX(${g[0]}deg) rotateY(${g[1]}deg) rotateZ(${g[2]}deg)`,
            ...
            u = e < 0 ? 1 + (1 - a.opacity) * e * n : 1 - (1 - a.opacity) * e * n, d = `translate3d(${d}) ${c} ` + p;
          if (t && a.shadow || !t) {
            let e = r.querySelector(".swiper-slide-shadow");
            if (e = !e && a.shadow ? S("creative", r) : e) {
              const w = l.shadowPerProgress ? h * (1 / l.limitProgress) : h;
              e.style.opacity = Math.min(Math.max(Math.abs(w), 0), 1)
            }
          }
          c = E(0, r);
          c.style.transform = d, c.style.opacity = u, a.origin && (c.style.transformOrigin = a.origin)
        }
      },
      setTransition: t => {
        ...
        }), h({swiper: w, duration: t, transformElements: e, allSlides: !0})
      },
    ...
    let {swiper: y, extendParams: t, on: s} = e;
    t({cardsEffect: {slideShadows: !0, rotate: !0, perSlideRotate: 2, perSlideOffset: 8}}), m({
      effect: "cards", swiper: y, on: s, setTranslate: () => {
        const {slides: n, activeIndex: o, rtlTranslate: d} = y, c = y.params.cardsEffect, {
          startTranslate: p,
          isTouched: u
        } = y.touchEventsData, m = d ? -y.translate : y.translate;
        for (let l = 0; l < n.length; l += 1) {
          var h = n[l], f = h.progress, v = Math.min(Math.max(f, -4), 4);
          let e = h.swiperSlideOffset,
            t = (y.params.centeredSlides && !y.params.cssMode && (y.wrapperEl.style.transform = `translateX(${y.minTranslate()}px)`), y.params.centeredSlides && y.params.cssMode && (e -= n[0].swiperSlideOffset), y.params.cssMode ? -e - y.translate : -e),
            s = 0;
          var g = -100 * Math.abs(v);
          let a = 1, i = -c.perSlideRotate * v, r = c.perSlideOffset - .75 * Math.abs(v);
          var w = y.virtual && y.params.virtual.enabled ? y.virtual.from + l : l,
            b = (w === o || w === o - 1) && 0 < v && v < 1 && (u || y.params.cssMode) && m < p,
            w = (w === o || w === o + 1) && v < 0 && -1 < v && (u || y.params.cssMode) && p < m;
          if (b || w) {
            const n = (1 - Math.abs((Math.abs(v) - .5) / .5)) ** .5;
            i += -28 * v * n, a += -.5 * n, r += 96 * n, s = -25 * n * Math.abs(v) + "%"
          }
          if (t = v < 0 ? `calc(${t}px ${d ? "-" : "+"} (${r * Math.abs(v)}%))` : 0 < v ? `calc(${t}px ${d ? "-" : "+"} (-${r * Math.abs(v)}%))` : t + "px", !y.isHorizontal()) {
            const n = s;
            s = t, t = n
          }
          b = v < 0 ? "" + (1 + (1 - a) * v) : "" + (1 - (1 - a) * v), w = `
      ...
      `;
          if (c.slideShadows) {
            ...
            (e = e || S("cards", h)) && (e.style.opacity = Math.min(Math.max((Math.abs(v) - .5) / .5, 0), 1))
          }
          h.style.zIndex = -Math.abs(Math.round(f)) + n.length, E(0, h).style.transform = w
        }
      }, setTransition: t => {
        ...
        }), h({swiper: y, duration: t, transformElements: e})
      }, perspective: () => !0, overwriteParams: () => ({watchSlidesProgress: !0, virtualTranslate: !y.params.cssMode})
    })
  }]), u
}();
(() => {
  const t = document.querySelector(".after-commercial-popup");
  document.querySelector(".commercial-offer-item");
  const s = document.querySelector(".commercial-offer");
  var e = document.querySelector(".commercial-button"), a = document.querySelector(".order-button"),
    i = document.querySelector(".commercial-close"), r = document.querySelector(".after-commercial-close");
  const l = document.querySelector(".status-select");
  var n = document.querySelector("#after-commercial-close");
  const o = document.body;

  function bgShowHide() {
    const bgElement = document.querySelector('.background');
    const headerElement = document.querySelector('.header')
    if(headerElement.classList.contains('burger-clicked')) {
      headerElement.classList.remove('burger-clicked');
    } else {
      headerElement.classList.add('burger-clicked');
    }
    if(bgElement.classList.contains('showing')) {
      bgElement.classList.remove('showing');
    } else {
      bgElement.classList.add('showing');
    }
  }

  document.querySelector('.burger').addEventListener('click', bgShowHide);

  n && n.addEventListener("click", () => {
    t.classList.remove("show"), o.classList.remove("no-scroll")
  }), r && r.addEventListener("click", () => {
    t.classList.remove("show"), o.classList.remove("no-scroll")
  }), i && i.addEventListener("click", () => {
    s.classList.remove("show"), o.classList.remove("no-scroll"), l.style.color = "#A3A3A3", l.innerText = "Выберите из списка", d.style.maxHeight = "0", l.classList.remove("show")
  }), e && e.addEventListener("click", e => {
    s.classList.remove("show"), t.classList.add("show"), o.classList.add("no-scroll"), d.style.maxHeight = "0", l.classList.remove("show")
  }), a && a.addEventListener("click", () => {
    s && (s.classList.add("show"), s.style.top = window.scrollY.toString() + "px"), 700 < window.innerWidth && o.classList.add("no-scroll")
  });
  n = document.querySelectorAll(".status-item");
  const d = document.querySelector(".below"), c = (l && l.addEventListener("click", e => {
    l.classList.contains("show") ? (l.classList.remove("show"), d.style.maxHeight = "0") : (d.style.maxHeight = d.scrollHeight + "px", l.classList.toggle("show"))
  }), Array.from(n).forEach(e => {
    e.addEventListener("click", e => {
      d.style.maxHeight = "0", setTimeout(() => {
        l.innerText = e.target.innerText, l.classList.remove("show")
      }, 200)
    })
  }), document.querySelector(".burger")), p = document.querySelector(".navigation");
  r = document.querySelectorAll(".nav-item"), i = document.querySelector(".logo-image");
  document.addEventListener("click", e => {
    e.composedPath().includes(c) || (c.classList.remove("open"), p.classList.remove("open"), o.classList.remove("no-scroll"))
  }), i.onclick = () => {
    c.classList.remove("open"), p.classList.remove("open"), o.classList.remove("no-scroll")
  }, c && c.addEventListener("click", () => {
    c.classList.toggle("open"), p.classList.toggle("open"), c.classList.contains("open") && p.classList.contains("open") ? o.classList.add("no-scroll") : o.classList.remove("no-scroll")
  }), r.forEach(e => {
    e.addEventListener("click", () => {
      u.classList.remove("header-active")
    })
  });
  const u = document.querySelector(".header");
  window.onscroll = () => {
    1 < window.scrollY ? u.classList.add("header-active") : u.classList.remove("header-active")
  }
})();
